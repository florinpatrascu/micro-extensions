...
/**
 * jOOQ integration test
 *
 * @author <a href="mailto:florin.patrascu@gmail.com">Florin T.PATRASCU</a>
 * @since $Revision$ (created: 2014-04-01)
 */
public class JOOQTest {
  protected static final Log log = LogFactory.getLog(JOOQTest.class);
  public static Micro micro;
  private static SiteContext SITE;
  private static String EXTENSION_NAME = "jOOQ";
  ...
  public void testMicroContent() throws Exception {
    ...
    Assert.assertTrue(bodyAsString.contains("title=jOOQ"));
  }
